 ...
 * Size: 36 px
 * Bpp: 4
 * Opts: --bpp 4 --size 36 --font E:/projects/SquareLine_Projects/Echo_mate/main/assets/font/iconfont.ttf -o E:/projects/SquareLine_Projects/Echo_mate/main/assets/font\ui_font_iconfont36.c --format lvgl -r 0xe61e --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 980, .box_w = 63, .box_h = 37, .ofs_x = -1, .ofs_y = -5}
};
